...
canvas = screen.copy()
penImage=pygame.image.load(r'C:\Users\sidha\Downloads\Pen.png')
...
#Get the model histogram M
    M = cv2.calcHist([image_hsv], channels=[0, 1], mask=None, histSize=[180, 256], ranges=[0, 180, 0, 256] )
        ...
        if length > 0:
            ...
            if len(minDist)>0:             
                ...
                if  pos_prev is not None:
                    ...
                    drawpen(pos_prev[0]*1000/newx, pos_prev[1]*1000/newy-32)       
                    ...
                    if(abs(pos_prev[0]-pos_next[0])<=100 and abs(pos_prev[1]-pos_next[1])<=100): 
                        ...
                        pygame.draw.line(realdraw,color,orig,end,7)
                    ...
                    orig=(int(pos_next[0]*1000/newx),int(pos_next[1]*1000/newy))
                    pygame.draw.line(realdraw,color,end,end,7)
                    pos_prev=pos_next
        #print(pos_prev)        
